...
<%@ page language="C#" autoeventwireup="true" inherits="StatusDetailsPage, App_Web_statusdetailspage.aspx.cdcab7d2" %>
	
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
	<title>Untitled Page</title>
</head>
<body style="padding: 0; margin: 0px; border-style: none; background-color: White;">
	<form id="form1" runat="server" >
		<div>
			<asp:TextBox ID="StatusDetails" runat="server" CssClass="LogDetails" Height="200px"
				ReadOnly="True" Style="z-index: 100; left: 0px; position: absolute; top: 0px"
