<%@ page language="C#" autoeventwireup="true" inherits="Controls_NavigationPage, App_Web_navigationpage.aspx.cdcab7d2" %>
...
<body onload="initializeStartUp();" onclick="hidePopups(); callClosePopUp( 'delegationpopup' ); callClosePopUp( 'configureruntimeobjectpopup' ); callClosePopUp( 'stickynoteconfigurepopup' );">
	<form id="nonajaxform" bizappid="nonajaxform" runat="server" class="BizAPPform">
	<asp:Panel runat="server" ID="HeaderPanel" bizappid="HeaderPanel" Style="height: 0px;
