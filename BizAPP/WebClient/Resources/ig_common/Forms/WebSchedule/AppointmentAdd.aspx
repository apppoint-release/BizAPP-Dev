...
<%@ page uiculture="auto" culture="auto" language="c#" inherits="Forms.AppointmentAdd, App_Web_appointmentadd.aspx.b7514a0b" %>
<%@ Register TagPrefix="igtbar" Namespace="Infragistics.WebUI.WebSchedule.UltraWebToolbar" Assembly="Infragistics.WebUI.WebSchedule, Version=17.1.20171.1001, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" %>
<%@ Register TagPrefix="igtab" Namespace="Infragistics.WebUI.WebSchedule.UltraWebTab" Assembly="Infragistics.WebUI.WebSchedule, Version=17.1.20171.1001, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" %>
