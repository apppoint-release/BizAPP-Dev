<%@ page uiculture="auto" culture="auto" language="c#" autoeventwireup="false" inherits="Forms.Recurrence, App_Web_recurrence.aspx.b7514a0b" %>
<%@ Register TagPrefix="igsch" Namespace="Infragistics.WebUI.WebSchedule" Assembly="Infragistics.WebUI.WebSchedule, Version=17.1.20171.1001, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" %>
<%@ Register TagPrefix="cmb" Namespace="Forms" Assembly="BizAPP.Web.UI.Pages" %>
