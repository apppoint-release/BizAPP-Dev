...
function refreshNode() 
{
    if (lastOs != null) 
    {
        lastOs.parentNode.parentNode.parentNode.parentNode.nextSibling.firstChild.firstChild.firstChild.nextSibling.innerHTML = "Loading ..."
        if (!ob_t21(lastOs, lastUrl))
            ob_t21(lastOs, lastUrl);
    }
}
