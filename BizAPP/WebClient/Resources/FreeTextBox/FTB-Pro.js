...
\
	...
	\
	this.positionLeft = document.getElementById('s_positionLeft');\
	this.positionLeft.styleEditor = styleEditor;\
	window.opener.FTB_AddEvent(this.positionLeft,'keyup',function() {this.styleEditor.UpdateStylePreview(); });\
	this.positionLeftUnit = document.getElementById('s_positionLeft_unit');\
	this.positionLeftUnit.styleEditor = styleEditor;\
	window.opener.FTB_AddEvent(this.positionLeftUnit,'change',function() {this.styleEditor.UpdateStylePreview(); });\
	this.positionRight = document.getElementById('s_positionRight');\
	this.positionRight.styleEditor = styleEditor;\
	window.opener.FTB_AddEvent(this.positionRight,'keyup',function() {this.styleEditor.UpdateStylePreview(); });\
	this.positionRightUnit = document.getElementById('s_positionRight_unit');\
	this.positionRightUnit.styleEditor = styleEditor;\
	window.opener.FTB_AddEvent(this.positionRightUnit,'change',function() {this.styleEditor.UpdateStylePreview(); });\
	this.positionTop = document.getElementById('s_positionTop');\
	this.positionTop.styleEditor = styleEditor;\
	window.opener.FTB_AddEvent(this.positionTop,'keyup',function() {this.styleEditor.UpdateStylePreview(); });\
	this.positionTopUnit = document.getElementById('s_positionTop_unit');\
	this.positionTopUnit.styleEditor = styleEditor;\
	window.opener.FTB_AddEvent(this.positionTopUnit,'change',function() {this.styleEditor.UpdateStylePreview(); });\
	this.positionBottom = document.getElementById('s_positionBottom');\
	this.positionBottom.styleEditor = styleEditor;\
	window.opener.FTB_AddEvent(this.positionBottom,'keyup',function() {this.styleEditor.UpdateStylePreview(); });\
	this.positionBottomUnit = document.getElementById('s_positionBottom_unit');\
	this.positionBottomUnit.styleEditor = styleEditor;\
	window.opener.FTB_AddEvent(this.positionBottomUnit,'change',function() {this.styleEditor.UpdateStylePreview(); });\
	\
...
\
	...
	\
	if (this.positionLeft.value != '') try { el.style.left = this.positionLeft.value + this.positionLeftUnit.options[this.positionLeftUnit.selectedIndex].value; } catch(e) {} else el.style.left = '';\
	if (this.positionRight.value != '') try { el.style.light = this.positionRight.value + this.positionRightUnit.options[this.positionRightUnit.selectedIndex].value; } catch(e) {} else el.style.light = '';\
	if (this.positionTop.value != '') try { el.style.top = this.positionTop.value + this.positionTopUnit.options[this.positionTopUnit.selectedIndex].value; } catch(e) {} else el.style.top = '';\
	if (this.positionBottom.value != '') try { el.style.bottom = this.positionBottom.value + this.positionBottomUnit.options[this.positionBottomUnit.selectedIndex].value; } catch(e) {} else el.style.bottom = '';\
	\
...
FTB_StyleEditor.prototype.ReadElementStyle = function(el) {\
	...
	\
	this.SetUnitStyle(el.style.left, this.positionLeft, this.positionLeftUnit);\
	this.SetUnitStyle(el.style.right, this.positionRight, this.positionRightUnit);\
	this.SetUnitStyle(el.style.top, this.positionTop, this.positionTopUnit);\
	this.SetUnitStyle(el.style.bottom, this.positionBottom, this.paddingBottomUnit);\
	\
...
<fieldset>\
	...
	<table cellpadding='1' cellspacing='0' border='0'>\
		<tr><td class='f_title'>Left</td>\
			<td>\
				<input type='text' id='s_positionLeft' style='width: 50px;' />\
				<select id='s_positionLeft_unit'>\
					<option value='px'>px</option>\
					<option value='pt'>pt</option>\
					<option value='%'>%</option>\
					<option value='em'>em</option>\
		...
		<tr><td class='f_title'>Right</td>\
			<td>\
				<input type='text' id='s_positionRight' style='width: 50px;' />\
				<select id='s_positionRight_unit'>\
					<option value='px'>px</option>\
					<option value='pt'>pt</option>\
					<option value='%'>%</option>\
					<option value='em'>em</option>\
		...
		<tr><td class='f_title'>Top</td>\
			<td>\
				<input type='text' id='s_positionTop' style='width: 50px;' />\
				<select id='s_positionTop_unit'>\
					<option value='px'>px</option>\
					<option value='pt'>pt</option>\
					<option value='%'>%</option>\
					<option value='em'>em</option>\
		...
		<tr><td class='f_title'>Bottom</td>\
			<td>\
				<input type='text' id='s_positionBottom' style='width: 50px;' />\
				<select id='s_positionBottom_unit'>\
					<option value='px'>px</option>\
					<option value='pt'>pt</option>\
					<option value='%'>%</option>\
					<option value='em'>em</option>\
