...
function ob_t21(os, url) 
{
	...
	try
	{
	 ot = os.parentNode.parentNode.parentNode.parentNode.nextSibling;    	
	}
	catch(e)
	{
	}
...
function ob_t22(ob_od, ev) {			
	...
	if ((ev && ev.ctrlKey && ob_op2.className == "ob_t3") || (!ev || !ev.ctrlKey))
	{
	    ...
	    {
	        inited = 0;
	        if(ob_lastControlSelected.blur())
